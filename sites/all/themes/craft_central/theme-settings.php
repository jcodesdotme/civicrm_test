 ...
 *   The form state.
 */
function craft_central_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','craft_central'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'craft_central'),
  ...
  $form['prof_settings']['top_social_link']['twitter_username'] = array(
    ...
    '#default_value' => theme_get_setting('twitter_username', 'craft_central'),
  ...
  $form['prof_settings']['top_social_link']['facebook_username'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_username', 'craft_central'),
