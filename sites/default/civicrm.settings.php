...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/craftcent?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost:3306/craftcent_crm?new_link=true');
  }
}
...
$civicrm_root = 'C:/Users/User/Sites/craftcentral.test/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:/Users/User/Sites/craftcentral.test\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://craftcentral.test/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '411a8dd59259cf73af50f55a8f202ba1');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:/Users/User/Sites/craftcentral.test\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
